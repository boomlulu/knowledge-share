...
const scenes = [
  ...
  },
  {
    ...
    visual: "dataLeak",
    payoff: "点出真实根因线索：动画驱动逻辑没有被定点数约束。",
    hook: "这么小的漏口，为什么会变成世界报警？",
    minutes: "5:30 - 7:00",
  ...
  },
  {
    ...
    visual: "toolValue",
    payoff: "把工具价值拔高为企业级门槛：先看见，再定位。",
    hook: "看见不同步后，下一步最难的是什么？",
    minutes: "7:00 - 9:00",
  ...
  },
  {
    ...
    visual: "traceFrame",
    payoff: "说明工具只是开始，不是终点。",
    hook: "一帧里的小差异，凭什么能滚成整个世界对不上？",
    minutes: "9:00 - 10:00",
  ...
  },
  {
    ...
    visual: "mobaMap",
    payoff: "切入手机射击 MOBA 的真实踩坑案例。",
    hook: "普通 MOBA 场景里，分叉最早发生在哪？",
    minutes: "10:00 - 11:30",
  ...
  },
  {
    ...
    visual: "minionGuess",
    payoff: "把确定性问题落到一个具体判断上。",
    hook: "如果两个客户端算出不同结果，会怎样？",
    minutes: "13:00 - 14:30",
  ...
  },
  {
    ...
    visual: "chain",
    payoff: "完成“小差异变大问题”的核心解释。",
    hook: "客户端算一致这么难，能不能别让客户端算？",
    minutes: "16:00 - 18:00",
